            ...
            <div className="InboxContainer">
                    ...
                    ?
                        inbox.data.items.map((item)  =>
                            <div key={item.id}
                                ...
                                <div className="Thumbnail"><img className="HexagonThumbnail" src={`data:image/png;base64,${item.thumbnail}`}
                                                                alt="profile "/></div>
                ...
                <div className="DemoShow">
                    ...
                    <div className="DemoInfo">
                        ...
                        <button className="StartButton" onClick={start}>Review</button>
